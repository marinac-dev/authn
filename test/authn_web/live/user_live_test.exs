defmodule AuthnWeb.UserLiveTest do
  use AuthnWeb.ConnCase

  import Phoenix.LiveViewTest
  import Authn.AccountsFixtures

  @create_attrs %{cose_key: "some cose_key", key_id: "some key_id", password: "some password", username: "some username"}
  ...
  describe "Index" do
    ...
    test "updates user in listing", %{conn: conn, user: user} do
      ...
      assert html =~ "some updated cose_key"
    end
